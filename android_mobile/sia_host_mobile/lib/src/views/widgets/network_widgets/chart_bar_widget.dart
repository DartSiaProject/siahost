...
class BarChartNetwokingWidget extends StatefulWidget {
  ...
  // final Color barBackgroundColor = contentColorWhite.darken().withOpacity(0.3);
  // final Color barColor = contentColorWhite;
  // final Color touchedBarColor = contentColorGreen;
...
class BarChartNetwokingWidgetState extends State<BarChartNetwokingWidget> {
                ...
                children: <Widget>[
                  ...
                  Flex(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        LanguageTranslationHelper.of(context)!
                            .translate("track_text"),
                        style: TextStyle(
                          fontFamily: "DmSans",
                          color: caribbeanGreenColor,
                          fontSize: 16.0.sp,
                          fontWeight: FontWeight.w700,
                        ),
                      ),
    ...
    return BarChartGroupData(
      ...
      barRods: [
        BarChartRodData(
          ...
          // isTouched ? widget.touchedBarColor : barColor,
          width: 18.0.w,
  ...
  List<BarChartGroupData> showingGroups() =>
      ...
      // widget.activeContractCount
      //     .map((point) => makeGroupData(
      //           point,
      //           point.toDouble(),
      //         ))
      //     .toList();
