...
import 'package:sia_host_mobile/src/views/widgets/host_widgets/infos_list_widget.dart';
import 'package:sia_host_mobile/src/views/widgets/host_widgets/price_info_bar_widget.dart';
        ...
        children: <Widget>[
          ...
          Flex(
            ...
            children: <Widget>[
              ...
              Text(
                widget.hostModel
                    .countryCode, // todo : il manque la ville et le pays , il y'a seulement le country
                style: TextStyle(
                  fontFamily: "DmSans",
                  fontSize: 17.0.sp,
