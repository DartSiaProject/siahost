...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  Widget build(BuildContext context) {
    return
        ...
        //               child: Text(
        //                 Translator.of(context)!.translate(Lang.adressPublicText),
        //                 style: TextStyle(
        //                   fontFamily: "Inter",
        //                   fontSize: 16.0.sp,
        //                   color: ColorsApp.whiteColor,
        ...
        //               padding: const EdgeInsets.all(5.0),
        //               child: Text(
        //                 Translator.of(context)!.translate(Lang.renterdPasswordText),
        //                 style: TextStyle(
        //                   fontFamily: "Inter",
        //                   fontSize: 16.0.sp,
        //                   color: ColorsApp.whiteColor,
        ...
        //               decoration: InputDecoration(
        //                 hintText:
        //                     Translator.of(context)!.translate(Lang.passwordText),
        ...
        //                       )
        //                     : Text(
        //                         Translator.of(context)!.translate("connect_text"),
        //                         style: TextStyle(
        //                           fontFamily: "Roboto",
        //                           fontSize: 20.0.sp,
        //                           color: ColorsApp.whiteColor,
