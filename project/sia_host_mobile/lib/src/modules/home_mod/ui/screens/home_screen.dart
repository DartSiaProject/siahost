  ...
  Widget build(BuildContext context) {
    return Flex(
      ...
      children: <Widget>[
        ...
        Expanded(
          child: BlocBuilder<NetworkDataFetchingBloc, NetworkDataFetchingState>(
            builder: (context, networkDataFetchingBuilderState) {
              if (networkDataFetchingBuilderState is NetworkDataFetchedFailed) {
                return Center(
                  child: Flex(
                    ...
                    children: <Widget>[
                      Text(
                        Translator.of(context)!
                            .translate(networkDataFetchingBuilderState.message),
                        style: TextStyle(
                          fontFamily: "Roboto",
                          fontSize: 20.0.sp,
                          color: ColorsApp.whiteColor,
